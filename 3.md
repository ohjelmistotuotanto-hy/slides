...
- Kehittäjätiimi voi strukturoida vaatimusten kartoitusta
  - Mietitään kuviteltuja käyttäjiä ja keksitään käyttäjille tyypillisiä käyttöskenaarioita
...
- _Toimintaympäristön rajoitteita_ (constraints) ovat esim:
  ...
  - Integroituminen muihin järjestelmiin (kirjautuminen google-tunnuksilla)
...
- Tiedetään että jos määrittelyssä tehdään virhe, joka huomataan vasta testauksessa, on muutoksen tekeminen kallista
...
- Tehdään hypoteesi miten asiakkaat käyttäytyisivät, jos kyseinen järjestelmä tai toiminnallisuus olisi toteutettu
...
- Järjestelmästä mitattua käyttäytymistä verrataan alussa asetettuun hypoteesiin ja katsotaan olivatko toteutetut toiminnallisuuden käyttäjien mieleen
...
![](https://ohjelmistotuotanto-hy.github.io/images/2-4.jpg){ width=450 }
