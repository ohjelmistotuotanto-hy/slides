...
Kurssi on jo ohjelmointia hallitseville tarkoitettu johdanto _ohjelmistotuotantoon_, eli systemaattiseen tapaan tehdä hieman laajempia ohjelmistoja useamman hengen tiimissä ulkoiselle asiakkaalle

. . .

Erityinen paino kurssilla on niin sanotuissa ketterissä ohjelmistotuotantomenetelmissä. 


# Kurssin oppimistavoitteet

Kurssin suoritettuaan tulisi omata riittävät tiedolliset ja tekniset valmiudet toimia _juniorikehittäjän roolissa_ pienessä ohjelmistotiimissä, esim. opintojaksolla _ohjelmistotuotantoprojekti_
...
Vasta _lopussa tapahtuva laadunhallinta_ paljastaa ongelmat liian myöhään
...
_Tukivat erityisesti laajojen, pitkäikäisten ohjelmistojen kehitystyötä_, mutta pienten ja keskisuurten ohjelmistojen tekoon turhan jäykkiä
...
Ristiriidan seurauksena syntyi joukko **ketteriä prosessimalleja** (agile) 
