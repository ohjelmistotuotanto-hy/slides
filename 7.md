...
- ja sitä testataan
  - esim. osa käyttäjien liikenteestä ohjata aktiivisen lisäksi passiiviseen ympäristöön ja varmistaa, että se toimii odotetulla tavalla
...
- Monitoroidaan palvelimen yleisen toimivuuden lisäksi seurata
...
- Asettaa haasteita, jos järjestelmään toteutetut uudet ominaisuudet edellyttävät muutoksia tietokannan skeemaan
  - Tarvitaan yhtä aikaa sekä tietokannan uutta että vanhaa versiota

. . .

- Jos versiot käyttävät eri tietokantaa, täytyy kantojen tila synkronoida, jotta järjestelmien vaihtaminen onnistuu saumattomasti
...
- Kun valmiina laajempaan testattavaksi, julkaistaan esim. ensin kehittäjäyrityksen omaan käyttöön ja lopulta osalle käyttäjistä canary releasena
...
- Perinteisesti tarkka erottelu sovelluskehittäjien (developers, dev) ja ylläpitäjien (operations, ops) välillä
...
- DevOps on termi hypetermi, jonka merkitys osin epäselvä
...
- Suurin osa määritelmistä tarkoittaa DevOpsilla _kehittäjien ja järjestelmäylläpidon yhteistä työnteon tapaa_, ja sen takia onkin hyvä puhua DevOps-kulttuurista
...
- Eräs tärkeimmistä devops:ia mahdollistavista asioista _infrastructure as code_
