...
- Priorisoidun listan kärkipään vaatimukset valitaan toteutettavaksi seuraaviin sprintteihin
  - ne ovat kirjattu tarkemmalla tasolla kuin backlogin häntäpään vaatimukset
...
- Kokouksella kaksi tavoitetta, Scrumin sanoin _aiheetta_ (engl. topic)
...
- Ensimmäisen aihe on selvittää _mitä_ sprintin aikana tehdään
  ...
  - Tiimi arvioi kuinka monta backlogin vaatimuksista se kykenee sprintin aikana toteuttamaan definition of donen määrittelemällä laadulla)
...
- Scrum sisältää joukon _arvoja_ (engl. values) joiden noudattamista se pitää oleellisena: _commitment, focus, courage, respect_
