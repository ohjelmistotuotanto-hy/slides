...
- Inkrementaalinen lähestymistapa arkkitehtuurin muodostamiseen edellyttää koodilta hyvää sisäistä laatua ja kehittäjiltä kurinalaisuutta, muuten seurauksena on kaaos
...
- Ohjelmistosuunnittelu on "enemmän taidetta kuin tiedettä", kokemus ja hyvien käytänteiden opiskelu toki auttaa
  - kehitetty monia suunnittelumenetelmiä, mikään niistä ei ole vakiintunut

#

- Ylläpidettävyyden ja laajennettavuuden kannalta hyvällä koodilla joukko yhteneviä ominaisuuksia, tai _laatuattribuutteja_, esim. seuraavat:
  - kapselointi
...
- _Suunnittelumallit_ auttavat luomaan koodia, joissa sisäinen laatu kunnossa
  - kurssin aikana nähty jo _dependency injection_, _singleton_, _data access object_
  - lisää kurssimateriaalissa ja laskareissa

# Koodin laatuattribuutti: kapselointi

- Ohjelmoinnin peruskurssilla _kapselointi_ määritellään seuraavasti
  - _oliomuuttujat tulee määritellä privaateiksi ja niille tulee tehdä tarvittaessa setterit ja getterit_
...
- Luokkatason koheesiossa pyrkimyksenä on, että luokan _vastuulla_ on vain yksi asia,  tunnetaan myös nimellä _single responsibility periaate_
...
- Hyödynnetään usein meille tuttua _dependence injection_ -suunnittelumallia
...
- Suoraviivainen copypaste on helppo eliminoida esim. metodien avulla
